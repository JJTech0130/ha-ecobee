...
class EcobeeFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            if CONF_AUTH0_TOKEN in user_input:
                self._ecobee = Ecobee(config={ECOBEE_API_KEY: "", ECOBEE_AUTH0_TOKEN: user_input[CONF_AUTH0_TOKEN], ECOBEE_REFRESH_TOKEN: ""})
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                {vol.Optional(CONF_API_KEY, default=stored_api_key): str,
                 vol.Required(CONF_AUTH0_TOKEN): str,}
            ),
            errors=errors,
        )
        ...
        if user_input is not None:
            ...
            if await self.hass.async_add_executor_job(self._ecobee.request_tokens):
                ...
                config = {
                    ...
                    CONF_AUTH0_TOKEN: self._ecobee.auth0_token,
                }
    ...
    async def async_step_import(self, import_data):
        ...
        try:
            ...
            config = {
                ...
                ECOBEE_AUTH0_TOKEN: legacy_config[ECOBEE_AUTH0_TOKEN],
            }
        ...
        if await self.hass.async_add_executor_job(ecobee.refresh_tokens):
            ...
            return self.async_create_entry(
                ...
                data={
                    ...
                    CONF_AUTH0_TOKEN: ecobee.auth0_token,
                },
            )
        return await self.async_step_user(
            user_input={
